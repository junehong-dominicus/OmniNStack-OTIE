...
const (
	ProcessorService_Process_FullMethodName     = "/otie.processor.v1.ProcessorService/Process"
	ProcessorService_CheckHealth_FullMethodName = "/otie.processor.v1.ProcessorService/CheckHealth"
)
...
type ProcessorServiceClient interface {
	// Manual trigger for synchronously processing a payload (primarily for testing/dev)
...
var ProcessorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "otie.processor.v1.ProcessorService",
	...
	Metadata: "api/v1/processor/processor.proto",
}
