...
func main() {
	log.Println("🔌 Connecting to OTIE Collector via gRPC on otie-collector-service:50051...")
	conn, err := grpc.NewClient("otie-collector-service:50051", grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
